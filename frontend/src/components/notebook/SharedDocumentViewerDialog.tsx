...
import { sharedDocumentFileUrl } from "@/services/notebookService";
...
export function SharedDocumentViewerDialog({
  token,
  documentId,
  filename,
  sizeBytes,
  ...
  const fileUrl = useMemo(
    () => (documentId ? sharedDocumentFileUrl(token, documentId) : null),
    [token, documentId],
  );
